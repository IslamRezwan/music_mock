      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              'Hello, There', style: TextStyle(fontSize: 32.0, color: themeC, fontFamily: 'Product Sans')
            ),
            Padding(
            ...
            Text(
              ...
              style: TextStyle(fontFamily: 'Product Sans', fontSize: 28.0, color: themeC),
            ),
            Padding(
              padding: EdgeInsets.all(16.0),
            ),
            ...
            Text(
              'Continue Listening',
              style: TextStyle(fontSize: 26.0, color: themeC, fontFamily: 'Product Sans')
            ),
            songlist,
          ],
        ),
